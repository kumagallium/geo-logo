...
共有された Rikyū の出力 5 点を、いまの語彙で 1 枚ずつ手描きして、どこまで届くかを
実測しました。**届かなかった主因の 3 つは能力不足ではなく、直前に入れたバグ**でした。
...
Rikyū の出力を 5 点まとめて見ると、**例外なく持っている操作**が 1 つありました。
重なった部品の境目が、どこも同じ太さの白で分かれています——翼と胴、首と胸、
顎と頬、花弁と円板。これが無いと部品が黒い塊へ溶けます。
...
切り離されます（幾何としては正しい。Rikyū のペガサスの翼も実際に離れています）。
