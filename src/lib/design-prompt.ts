...
## パラメータ
- **ratio** — 比例体系。マークの性格を決めます。**迷ったら silver。**
  家紋 39 点の半径を実測すると、隣り合う寸法の比はほぼ √2 でした。
  黄金比は語りやすいだけで、作図された紋が実際に使っているのは白銀比です。
  - silver（白銀比 √2=1.414）: 静か・端正・伝統。既定。実測がこれ
  - golden（黄金比 φ=1.618）: 有機的・力強い・成長。自然や生命の主題に
